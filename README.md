...
<div align="center">
  <img alt="Coding" width="100" src="https://raw.githubusercontent.com/DanielMinaya1/DanielMinaya1/main/static/gifs/EscuelaDevRock.gif" />
</div>
...
- 🛰️ Developing deep learning models for satellite image analysis
- 🏗️ Building automated data pipelines for construction site monitoring
- 🔄 Designing ETL processes and data transformation workflows
...
**AWS Services**: S3, Glue, Lambda, Athena, EventBridge  
**GCP Services**: AutoML, Cloud Natural Language
...
### 🛰️ Satellite Image Analysis for Construction Monitoring
Deep learning models using CNNs for automated classification of construction site states from Google Earth imagery

### ☁️ AWS Data Pipelines
ETL pipeline development using AWS Glue, Lambda functions, and serverless architectures with EventBridge orchestration

### 💬 Sentiment Analysis System
NLP application using Google Cloud Natural Language and AutoML for customer support ticket analysis

### 📐 Mathematical Modeling
Neural network training formulated as optimal control problems, and image segmentation using partial differential equations
